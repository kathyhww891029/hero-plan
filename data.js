...
const DAD_GUIDE = {
  ...
  kidRules: [
    ...
    { icon:'📚', title:'今日任务', desc:'写完作业，是每天最重要的一件事\n专心写，不分心\n你会发现自己比想象中厉害得多' },
    { icon:'🎯', title:'专注力时光', desc:'选一件你喜欢的事\n积木、拼图、折纸……都可以\n专心做15分钟\n停不下来？没关系，继续！\n那是最棒的状态' },
  ],
  kidOptional: '口算、英语、音乐\n做了就来领分\n不做也没关系\n等你某天突然很想做，那就是最好的时机',
  kidShop: [
    { icon:'🎮', name:'游戏+15分钟', cost:40 },
    { icon:'🍭', name:'今晚零食你来选', cost:50 },
    { icon:'🎬', name:'周五电影你来定', cost:65 },
    { icon:'🎮', name:'游戏+30分钟', cost:80 },
    { icon:'✏️', name:'文具盲盒', cost:100 },
    { icon:'🍰', name:'和妈妈吃蛋糕', cost:120 },
  ],
  kidSelf: '每次你自己想起来做\n不用爸爸妈妈提醒\n\n那一分\n比其他任何一分都珍贵\n\n因为那是你自己的力量',
  kidClosing: '你知道吗——\n\n每次你自己想起来穿衣服\n每次你专心做完一件事停不下来\n每次你说「我来！」而不是等人叫你\n\n那一刻，你就已经赢了\n\n积分不是最重要的事\n最重要的是有一天你会发现：\n「原来我能做到。」\n\n那种感觉\n比任何奖励都厉害\n\n爸爸妈妈不是来监督你的\n我们是你的啦啦队\n\n你每往前走一步\n我们都看见了\n\n这一路上，我们一起走。\n\n爱你的爸爸妈妈 💛',
};
