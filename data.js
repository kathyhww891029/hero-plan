...
const SHOP = [
  {
    ...
    items:[
      { id:'mom1', icon:'🍭', name:'今晚我选零食', note:'今晚零食我说了算！', cost:30 },
      { id:'mom2', icon:'🎮', name:'和平精英：周末多玩15分钟', note:'周末游戏+15分钟', cost:25 },
      { id:'mom3', icon:'🎮🎮', name:'和平精英：周末多玩30分钟', note:'周末游戏+30分钟', cost:45 },
      { id:'mom4', icon:'🎬', name:'周五电影我选片', note:'这周五选什么我决定！', cost:35 },
      { id:'mom5', icon:'🎂', name:'和妈妈一起吃蛋糕', note:'妈妈陪我一起吃个蛋糕 🍰', cost:80 },
      { id:'mom6', icon:'🎁', name:'文具盲盒一个', note:'神秘文具盲盒，自己拆！', cost:60 },
      { id:'mom7', icon:'🧸', name:'小玩具一个', note:'自己选一个小玩具', cost:90 },
      { id:'mom8', icon:'✨', name:'神秘惊喜（妈妈决定）', note:'妈妈给你一个特别的惊喜！', cost:120 },
    ]
  },
  {
    type:'💪 爸爸专区', color:'#118AB2', lightColor:'#E8F4FD',
    items:[
      { id:'dad1', icon:'💃', name:'爸爸陪我跳舞30分钟', note:'爸爸专属时光！一起跳舞', cost:25 },
      { id:'dad2', icon:'🏆', name:'爸爸给我办运动颁奖典礼', note:'爸爸准备仪式，表彰运动成就', cost:20 },
      { id:'dad3', icon:'🤸', name:'爸爸陪我学一个新运动动作', note:'爸爸教新动作，学会才算完成', cost:20 },
      { id:'dad4', icon:'🗺️', name:'爸爸带我去没去过的地方探索', note:'户外探索，爸爸主导！', cost:60 },
      { id:'dad5', icon:'🌄', name:'爸爸陪我看日出/日落', note:'一起的安静时光 🌅', cost:45 },
      { id:'dad6', icon:'🏔️', name:'爸爸带我去爬一座新山', note:'大型户外挑战！需提前计划', cost:80 },
      { id:'dad7', icon:'🎬😴', name:'爸爸看完整部电影不睡着', note:'【彩蛋】全程监督爸爸！撑住不睡！', cost:30, isEgg:true },
    ]
  },
];
...
const ROPE_MILESTONES = [
  { target:130, bonus:5, label:'⚡ 即将到达！', unlock:null },
  { target:150, bonus:8, label:'⭐ 解锁运动加强包', unlock:'运动加强包' },
  { target:170, bonus:10, label:'🔥 奥特曼最终形态！', unlock:null },
  { target:200, bonus:20, label:'🏆 宇宙英雄！爸爸颁奖典礼自动触发', unlock:'颁奖典礼', autoTrigger:'dad2' },
];
