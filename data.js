...
// ── 全局常量 ──────────────────────────────────────────────────
var STATE_KEY = 'hero_plan_state_v2';

// ── 升级与里程碑阈值（从 hero-constants.js 迁移过来）─────────
const WEEK_UNLOCK_DAYS = 7;           // 注册后多少天解锁专项卡
const BACKFILL_SCORE_RATE = 1.0;      // 补卡通过审核：获得该任务正常积分的 100%
const PHASE_UPGRADE_SCORE = 100;      // 升到下一阶段所需累计积分
