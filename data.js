...
const TASK_CARDS = [
  ...
  // 🎤 演出里程碑系列（新增，爸爸是音乐家）
  {
    ...
    speech:'父子首演家庭小剧场！在家里举办演出，爸爸伴奏你表演，邀请妈妈当观众，完整演完就是英雄，得15分！需要40分解锁！'
  },
  {
    ...
    tip:'👏 演出计划：\n①和爸爸商量表演内容和地点\n②出门找一个小空地\n③爸爸演奏，你配合表演\n④有一个人停下来看，就算成功！\n勇敢踏出家门就是最大的进步🌟',
    speech:'父子街头艺术家！和爸爸一起出门表演，找一个小空地，有一个路人停下来看就算成功，得25分！需要80分解锁！'
  },
  {
    ...
    score:40, unlockAt:120, unlocked:false,
    tip:'✨ 这是最高荣誉：\n①爸爸安排你参与他的正式演出\n②可以是伴舞、可以是背景音效、可以是最简单的配合\n③只要你出现在演出现场并参与其中就算完成\n这将是你们父子之间最特别的记忆 💛',
    speech:'父子乐队正式演出！参与爸爸的正式演出，哪怕只是最简单的配合，得40分！这是最高荣誉！需要120分解锁！'
  },
];
...
const SHOP = [
  {
    ...
    items:[
      { id:'mom2', icon:'🎮', name:'玩平板/手机游戏：周末多玩15分钟', note:'周末游戏+15分钟', cost:25, speech:'玩平板手机游戏多玩15分钟！花25分，周末游戏时间加15分钟，好好享受！' },
      ...
      { id:'mom3', icon:'🎮🎮', name:'玩平板/手机游戏：周末多玩30分钟', note:'周末游戏+30分钟', cost:45, speech:'玩平板手机游戏多玩30分钟！花45分，周末游戏时间加30分钟，双倍快乐！' },
