...
function renderKidPage() {
  ...
  el.innerHTML = `
    <div class="dad-guide">
      <div class="dad-guide-header">${g.kidTitle} <button onclick="event.stopPropagation();speakText(/* ══════════════════════════════════════════════════════════════
   英雄成长计划 · 主逻辑
══════════════════════════════════════════════════════════════ */
...
function renderKidPage() {
  ...
  const g = DAD_GUIDE;
  const nl2br = s => s.replace(/\n/g, '<br>');
,this)" style="background:none;border:none;font-size:1.2rem;cursor:pointer;vertical-align:middle;" title="读给我听">🔈</button></div>
      <div class="dad-guide-body">
        ...
        <div class="dad-tip-box" style="background:#EDFFF9;border-left:4px solid #06D6A0;margin-top:16px;text-align:center">
          ...
          <button onclick="event.stopPropagation();speakText(/* ══════════════════════════════════════════════════════════════
   英雄成长计划 · 主逻辑
══════════════════════════════════════════════════════════════ */
...
function renderKidPage() {
  ...
  const g = DAD_GUIDE;
  const nl2br = s => s.replace(/\n/g, '<br>');
,this)" style="background:#06D6A0;border:none;color:#fff;border-radius:20px;padding:6px 16px;font-size:0.85rem;margin-top:10px;cursor:pointer;">🔈 读给我听</button>
        </div>
      </div>
    </div>`;
}
