/* ══════════════════════════════════════════════════════════════
   英雄成长计划 · Service Worker v118
   策略：index.html 网络优先（保证 PWA 始终获取最新版本）
         JS/CSS 缓存优先（query string 版本控制）
         v118 强制清除所有旧缓存，彻底解决 iPad 顽固缓存
══════════════════════════════════════════════════════════════ */
const CACHE_NAME = 'hero-plan-v118';
const CACHE_DATE = '2026-05-12-visible-version';

// 核心资源（v118 更新 URL 版本号）
const urlsToCache = [
  './',
  './index.html',
  './style.css',
